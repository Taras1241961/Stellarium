...
public class HygStar {
    ...
    private int hipId;
    private String name;
    private double ra;      // прямое восхождение в радианах
    private double dec;     // склонение в радианах
    private double mag;     // звёздная величина
    ...
    // Геттеры - именно их вызывает StarSpherePanel
