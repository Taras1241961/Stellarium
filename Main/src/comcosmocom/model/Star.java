...
public class Star {
    ...
    public String getName() {
        return name != null ? name : "Звезда " + id;
    }
    ...
    public String toString() {
        return String.format("Star{id=%d, name='%s', RA=%.2fч, Dec=%.2f°, mag=%.2f}",
                id, getName(), getRightAscensionHours(), getDeclinationDegrees(), magnitude);
    }
}